...
EEconn_chg_factor = np.arange(1.1, 1.91, 0.1)# np.arange(1.2, 2.1, 0.2)#np.array([0.9])
EIconn_chg_factor = np.arange(0.2, 1.01, 0.2)#np.arange(0.60, .71, 0.1)#np.arange(0.6, 3, 0.2)#np.array([2.0])
...
C_rng = np.arange(1, 8.1, 1).astype(int)
E3E1_cond_chg = 0.2
E3I1_cond_chg = 1.0
