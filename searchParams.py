...
EEconn_chg_factor = np.array([3.0])#np.arange(2.1, 2.9, 0.1)# np.arange(1.2, 2.1, 0.2)#np.array([0.9])
EIconn_chg_factor = np.array([0.2])#np.arange(0.1, 0.4, 0.1)#np.arange(0.60, .71, 0.1)#np.arange(0.6, 3, 0.2)#np.array([2.0])
