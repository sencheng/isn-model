...
C_rng = np.arange(1, 4.1, 1).astype(int)
E3E1_cond_chg     = 0.2
E3I1_cond_chg     = 1.0
EE_probchg_comb, EI_probchg_comb, II_condchg_comb, E_extra_comb, bkg_chg_comb, CA3_CP_comb = \
    np.meshgrid(EEconn_chg_factor, EIconn_chg_factor, IIconn_chg_factor, E_extra_stim_factor, bkg_chg_factor, CA3_conn_prob_fac)
extra_bkg_e = 2500.0
