...
E_extra_stim_factor = np.array([1])#np.arange(0.2, 1., 0.2)
EEconn_chg_factor = np.array([1])#np.arange(0.9, 0.95, 0.05)
EIconn_chg_factor = np.array([1])#np.arange(2.0, 2.01, 0.1)
